...
const HomePage = ({ posts }: any) => {
  return (
      ...
      <section className="bg-[#F1F5FA] pb-10  pt-16">
        <div className="conatiner">
          <div className="grid lg:grid-cols-2 overflow-hidden">
            ...
            <Title title="Areas We Serve" subTitle="Your Trusted Partner Across the Region​" />
    ...
    <FontAwesomeIcon icon={faCheckDouble} className="w-4" /> Palm Springs</li>
    <li className="font-archivo flex items-center gap-4 font-normal text-base text-gray-800">
    ...
    <li className="font-archivo flex items-center gap-4 font-normal text-base text-gray-800">
    <FontAwesomeIcon icon={faCheckDouble} className="w-4" />Portland</li>
</ul>
      ...
      <section className="py-10 px-20">
        ...
        <Title title="Baldwin Mader Law Group is currently investigating claims related to Paul Regan and Next Level. If you invested funds through Paul Regan and/or Next Level please contact our firm." className="text-center"  />
